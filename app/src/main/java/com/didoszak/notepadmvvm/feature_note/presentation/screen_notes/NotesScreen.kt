...
import com.didoszak.notepadmvvm.feature_note.domain.util.NoteItem
import com.didoszak.notepadmvvm.feature_note.presentation.screen_notes.components.OrderSection
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                IconButton(
                    onClick = {
                        viewModel.onEvent(NotesEvent.HideSorting)
                    }
                ) {
                    Icon(
